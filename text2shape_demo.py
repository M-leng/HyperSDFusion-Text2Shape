...
input_txt = "a soft chair."

ngen = 2 # number of generated shapes
ddim_steps = 100
ddim_eta = 0.
uc_scale = 3.
...
# vis as gif
gen_name = f'{out_dir}/ours-{input_txt}.gif'
...
pytorch3d.io.save_obj(f'{out_dir}/ours-{input_txt}.obj',mesh_gen.verts_list()[1],mesh_gen.faces_list()[1])