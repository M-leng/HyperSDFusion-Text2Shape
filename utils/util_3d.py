...
############################# START: renderer #######################################
def init_points_renderer(image_size=256, dist=1.7, elev=20, azim=20, camera='0', device='cuda'):
    # renderer
    # Initialize a camera.
...
def init_mesh_renderer(image_size=512, dist=3.5, elev=90, azim=90, camera='0', device='cuda'):
    # Initialize a camera.
